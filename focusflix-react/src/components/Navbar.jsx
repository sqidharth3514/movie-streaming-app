...
function Navbar({ onSearch }) {
  ...
  return (
    <nav
      className={`fixed top-0 w-full z-50 px-6 py-4 flex justify-between items-center transition duration-300 ${
        scrolled
          ? "bg-black/90 dark:bg-black shadow-lg backdrop-blur"
          : "bg-transparent"
      }`}
    >
      ...
      <div className="flex items-center gap-4">
        ...
        <input
          ...
          onChange={(e) => setQuery(e.target.value)}
          placeholder="Search movies..."
          className="bg-gray-800 dark:bg-gray-800 px-4 py-2 rounded text-white outline-none focus:ring-2 focus:ring-red-500 transition w-[220px]"
        />
